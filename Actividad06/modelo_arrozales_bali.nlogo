...
to go
  ...
  set H_t_promedio (lput mean [H_t] of patches H_t_promedio)
...
to calcular_cosecha
  ;; f_p fraccion de vecinos con el mismo itinerario que yo (efecto plaga)
  let f_p count vecinos_plaga with [I_t = [I_t] of myself ] / count vecinos_plaga
  ;; f_w fraccion de parches en el mundo con el mismo itinerario que yo (efecto riego)
...
to elegir_siguiente_itinerario
  let regla regla_decision ;; Obtenemos la regla seleccionada
